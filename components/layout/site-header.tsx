            ...
            <div className="flex items-center gap-2">
              ...
              */}
              ...
              <a
                ...
                className="glass-surface text-accent-300 hover:text-accent-200 inline-flex size-11 items-center justify-center rounded-full transition-colors hover:border-accent-300/40 xl:hidden"
              >
                <PhoneIcon />
              </a>
