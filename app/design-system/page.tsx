...
export default function DesignSystemPage() {
  return (
    <>
      <Section spacing="default" tone="subtle" width="wide">
        <SectionHeading
          level={1}
        ...
        />
        <div className="border-brand-300 bg-brand-50 mt-6 max-w-3xl rounded-lg border p-5">
      ...
      <Section spacing="default" width="wide" aria-labelledby="colour">
        <SectionHeading
          id="colour"
          eyebrow="Foundations"
          title="Colour"
      ...
      <Section spacing="default" tone="subtle" width="wide" aria-labelledby="contrast">
        <SectionHeading
          id="contrast"
      ...
      <Section spacing="default" width="wide" aria-labelledby="type">
        <SectionHeading
          id="type"
          eyebrow="Foundations"
          title="Typography"
      ...
      <Section spacing="default" tone="subtle" width="wide" aria-labelledby="buttons">
        <SectionHeading
          id="buttons"
          eyebrow="Components"
          title="Buttons and calls to action"
          lead={`Six variants, three sizes. Every control is at least ${minTouchTargetPx}px in both dimensions.`}
        />
        <div className="mt-8 flex flex-col gap-6">
          ...
          <div className="bg-surface-inverse flex flex-wrap items-center gap-3 rounded-lg p-5">
      ...
      <Section spacing="default" width="wide" aria-labelledby="cards">
        <SectionHeading
          id="cards"
          eyebrow="Components"
      ...
      <Section spacing="default" tone="inverse" width="wide" aria-labelledby="inverse">
        ...
        <dl className="mt-8 grid gap-4 sm:grid-cols-3">
          {[
            ...
            <div key={label} className="rounded-md border border-white/20 p-4">
